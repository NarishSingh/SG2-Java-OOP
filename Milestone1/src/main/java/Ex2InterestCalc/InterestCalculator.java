...
public class InterestCalculator {
     ...
     * @param investment - {double} principle
     * @param annual - {double} annual interest rate, will be converted to quarterly rate
     ...
     * @param investment - {double} principle
     * @param annual - {double} annual interest rate, will be converted to monthly rate
     ...
     * @param investment - {double} principle
     * @param annual - {double} annual interest rate, will be converted to daily rate
